      ...
      <div className="card" style={{ padding: '0.75rem' }}>
          ...
          editingId === ing.id ? (
            <div key={ing.id} style={ingredientStyles.row}>
              ...
              <div style={{ display: 'flex', gap: '0.125rem' }}>
                <button onClick={saveEdit} style={{ color: 'var(--accent)', padding: '0.25rem' }} title="Save">
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                    <polyline points="20 6 9 17 4 12"></polyline>
                  </svg>
                </button>
                <button onClick={() => setEditingId(null)} style={{ color: 'var(--text-secondary)', padding: '0.25rem' }} title="Cancel">
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                    <line x1="18" y1="6" x2="6" y2="18"></line>
                    <line x1="6" y1="6" x2="18" y2="18"></line>
                  </svg>
        ...
        {showNewRow ? (
          <div style={ingredientStyles.row}>
            ...
            <div style={{ display: 'flex', gap: '0.125rem' }}>
              <button onClick={addIngredient} style={{ color: 'var(--accent)', padding: '0.25rem' }} title="Add">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                  <polyline points="20 6 9 17 4 12"></polyline>
                </svg>
              </button>
              <button onClick={() => { setShowNewRow(false); setNewName(''); setNewQty(''); setNewNotes(''); setNewStore(''); }} style={{ color: 'var(--text-secondary)', padding: '0.25rem' }} title="Cancel">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                  <line x1="18" y1="6" x2="6" y2="18"></line>
                  <line x1="6" y1="6" x2="18" y2="18"></line>
                </svg>
